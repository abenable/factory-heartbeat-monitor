...
export const machines: Machine[] = [
  ...
  // ── Welding Line ──
  {
    ...
    vibration: 0.06,
    uptime: 98.3,
    lastService: "2026-05-06",
    nextService: "2026-08-03",
    runtimeHours: 5230,
  ...
  },
  {
    ...
    temp: 42.0,
    uptime: 96.4,
    lastService: "2026-05-24",
    nextService: "2026-08-24",
    runtimeHours: 3100,
...
export const alerts: AlertEvent[] = [
  {
    id: "A-1042",
    timestamp: "2026-07-18T14:02:41Z",
  ...
  {
    id: "A-1041",
    timestamp: "2026-07-18T13:45:12Z",
  ...
  {
    id: "A-1040",
    timestamp: "2026-07-18T13:18:09Z",
  ...
  {
    id: "A-1039",
    timestamp: "2026-07-18T11:10:05Z",
  ...
  {
    id: "A-1036",
    timestamp: "2026-07-17T22:14:55Z",
...
export const workOrders: WorkOrder[] = [
  {
    ...
    schedule: {
      startDate: "2026-07-17T14:05:00Z",
      expectedCompletion: "2026-07-19T20:00:00Z",
    },
    resources: {
    ...
    workLog: {
      actualStartTime: "2026-07-17T14:30:00Z",
    },
  },
  {
    id: "WO-2040",
    ...
    schedule: {
      ...
      expectedCompletion: "2026-07-21T17:00:00Z",
    },
    resources: {
  ...
  },
  {
    ...
    createdAt: "2026-07-16T13:25:00Z",
    ...
    schedule: {
      ...
      expectedCompletion: "2026-07-24T14:00:00Z",
    },
    resources: {
  ...
  },
  {
    ...
    schedule: {
      ...
      expectedCompletion: "2026-07-20T18:00:00Z",
    },
    resources: {
    ...
    authorizedBy: "Nakimbugwe",
    workLog: {
      actualStartTime: "2026-07-16T08:15:00Z",
    },
  },
  {
    id: "WO-2037",
    ...
    schedule: {
      ...
      expectedCompletion: "2026-07-26T12:00:00Z",
    },
    resources: {
  ...
  },
  {
    ...
    schedule: {
      ...
      expectedCompletion: "2026-07-25T14:00:00Z",
    },
    resources: {
  ...
  },
  {
    ...
    schedule: {
      startDate: "2026-07-16T08:00:00Z",
      expectedCompletion: "2026-07-16T11:00:00Z",
      actualStart: "2026-07-16T08:00:00Z",
      actualCompletion: "2026-07-16T10:45:00Z",
    },
    resources: {
    ...
    authorizedBy: "Nakimbugwe",
    workLog: {
      actualStartTime: "2026-07-16T08:00:00Z",
      actualCompletionTime: "2026-07-16T10:45:00Z",
