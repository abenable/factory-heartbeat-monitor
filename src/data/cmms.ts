...
export const machines: Machine[] = [
  ...
  },
  {
    ...
    installationDate: "2020-07-14",
    commissioningDate: "2020-07-28",
    powerRating: "18 kW",
  ...
  // ── Chassis Line 1 ──
  {
    ...
    installationDate: "2022-09-05",
    commissioningDate: "2022-09-15",
    powerRating: "1.5 kW",
  ...
  },
  {
    ...
    installationDate: "2021-08-30",
    commissioningDate: "2021-09-10",
    powerRating: "30 kW",
  ...
  // ── QIT ──
  {
    ...
    installationDate: "2018-10-01",
    commissioningDate: "2018-10-15",
    powerRating: "11 kW",
...
export const pmTasks: PMTask[] = [
  { id: "PM-01", machineId: "MS-TUBE-01", task: "Lens and nozzle inspection", intervalDays: 30, lastDone: "2026-04-20", nextDue: "2026-05-20", frequency: "monthly", procedures: "Inspect lens for burn marks. Check nozzle concentricity. Replace if kerf > 0.1 mm.", requiredTools: "Lens wipes, nozzle gauge", safetyInstructions: "Disable laser source. Wait 5 min after shutdown.", personInCharge: "Wagoli" },
  ...
  { id: "PM-03", machineId: "MS-MILL-01", task: "Coolant flush", intervalDays: 60, lastDone: "2026-03-05", nextDue: "2026-05-04", frequency: "monthly", procedures: "Drain old coolant. Flush tank with clean water. Refill with 5% concentrate mix.", requiredTools: "Drain pan, pH test kit", safetyInstructions: "Wear chemical-resistant gloves and goggles.", personInCharge: "Suubi" },
  { id: "PM-04", machineId: "WL-WELD-01", task: "Torch tip and liner check", intervalDays: 21, lastDone: "2026-04-24", nextDue: "2026-05-15", frequency: "weekly", procedures: "Remove worn tip. Clean threads. Install new tip. Verify gas flow.", requiredTools: "Tip wrench, wire brush", safetyInstructions: "Purge gas lines before disassembly.", personInCharge: "Tabalaata" },
  { id: "PM-05", machineId: "PS-SPRAY-01", task: "Paint pattern verification", intervalDays: 14, lastDone: "2026-04-24", nextDue: "2026-05-08", frequency: "weekly", procedures: "Run pattern test card. Check atomization. Record fan width.", requiredTools: "Pattern test card, calipers", safetyInstructions: "Use booth ventilation. Ground applicator.", personInCharge: "Wagoli" },
  { id: "PM-06", machineId: "PS-COMP-01", task: "Filter and oil check", intervalDays: 30, lastDone: "2026-04-25", nextDue: "2026-05-25", frequency: "monthly", procedures: "Replace oil filter. Check air filter. Sample oil for analysis.", requiredTools: "Filter wrench, sample bottle", safetyInstructions: "Depressurize receiver. Wear ear protection.", personInCharge: "Oumo" },
  { id: "PM-07", machineId: "CL2-SLING-01", task: "Hoist brake and chain inspection", intervalDays: 30, lastDone: "2026-04-10", nextDue: "2026-05-10", frequency: "monthly", procedures: "Test brake slip. Measure chain wear. Record load test.", requiredTools: "Chain gauge, load cell", safetyInstructions: "Tag out before entry. Use fall protection if elevated.", personInCharge: "Odeke" },
  { id: "PM-08", machineId: "QIT-TEST-01", task: "Analyzer drift check", intervalDays: 14, lastDone: "2026-04-24", nextDue: "2026-05-08", frequency: "weekly", procedures: "Run calibration gas. Verify zero and span. Replace filter if differential > limit.", requiredTools: "Calibration gas, filter wrench", safetyInstructions: "Rollers locked. Chock vehicle.", personInCharge: "Oumo" },
  { id: "PM-09", machineId: "CL1-VIN-01", task: "Stylus and vision calibration", intervalDays: 60, lastDone: "2026-03-31", nextDue: "2026-05-30", frequency: "monthly", procedures: "Replace worn stylus. Verify engraving depth. Calibrate vision camera.", requiredTools: "Stylus kit, depth gauge, calibration plaque", safetyInstructions: "Lock marking head. Wear eye protection.", personInCharge: "Mukisa" },
];
